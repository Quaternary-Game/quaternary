...
var entity : EntityGD
const trait_drag_item : Resource = preload("res://features/main_game/UI/traits/trait_drag_item.gd")
...
func closest_loci() -> int:
	var closest :Vector2= loci_coords.reduce(func (max_value: Vector2, value: Vector2) -> Vector2:
			var translated_max : Vector2= global_position + max_value
	...
	return loci_coords.find(closest)
